...
import { Upload, Video, FileX, CheckCircle, Loader2, Plus, Trash2, Volume2 } from 'lucide-react';
        ...
        <div className="flex flex-col items-center space-y-4">
          {isUploading ? (
            ...
            <div className="relative">
              ...
              <Volume2 className="w-8 h-8 text-purple-500 absolute -top-2 -right-2" />
              <Plus className="w-6 h-6 text-blue-600 absolute -bottom-1 -left-1" />
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Drag and drop or click to select multiple video/audio files • Max size: {Math.round(maxSize / (1024 * 1024 * 1024))}GB each
            </p>
            ...
            <p className="text-xs text-green-600 dark:text-green-400 font-medium">
              ✓ Multi-file editing and joining supported
            </p>
          </div>
        </div>
      </div>
